...
<body id="detail-program">
    ...
    <section id="intro" class="clearfix">
        ...
        <img id="bg-intro" class="float-right" src="{{ asset('front/img/icon/seminar.png') }}" alt="Man Work">

        <div class="container">
            <div class="intro-info">
                <h2>Seminar Nasional</h2>
                <p>"When Developer Should be Hacker"</p>
            <a href="{{ route('event.seminar') }}" class="btn btn-warning">Registrasi</a>
            </div>
            ...
            <div class="container">
                ...
                <div class="program-detail">
                    ...
                    <div id="narasumber" class="col-sm-6">
                        <img class="rounded-circle mx-auto d-block mb-2" src="{{ asset('front/img/pemateri/waviq.jpeg') }}" alt="Pemateri 1">
                        <h5 class="text-center">Waviq Subkhi</h5>
                        <p class="text-center text-muted">Ex-Dev Gojek</p>
                    </div>
                    ...
                    <div id="narasumber" class="col-sm-6">
                        ...
                        <p class="text-center text-muted">Head of Technology Crowde</p>
                    </div>
                    </div>
                    <br><br>
